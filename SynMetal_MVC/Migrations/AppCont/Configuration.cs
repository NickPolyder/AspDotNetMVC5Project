namespace SynMetal_MVC.Migrations.AppCont
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SynMetal_MVC.Models.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            MigrationsDirectory = @"Migrations\AppCont";
        }
